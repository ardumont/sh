...
(fset 'after-clojure-jack-in
      (lambda (&optional arg)
        "A macro to dispose emacs buffer as i'm used to after the clojure-jack-in is started."
        (interactive "p")
        (kmacro-exec-ring-item (quote ([24 48 24 50 24 111 24 98 115 108 105 109 101 return 24 51 24 111 134217848 109 117 108 116 return 134217790 108 101 105 110 32 109 105 100 106 101 32 45 45 108 97 122 121 116 101 115 116 return 24 111] 0 "%d")) arg)))

(global-set-key (kbd "C-c C-j C-i") 'after-clojure-jack-in)
